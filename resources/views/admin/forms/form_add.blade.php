            ...
            <div class="container-fluid">
                ...
                <div class="row pt-2 m-2 align-items-center">
                    <div class="col-sm-6 col-6">
                        <h3 class="m-0 text-dark editprofile-main-heading">Add New Form </h3>
                    </div>
                </div>
                <div class="main-text-head slava-primary-bg m-2">
                    <h4 class="main-text-name text-white">Add New Form</h4>
                </div>
                        ...
                        <form class="employee-det-add">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="name">Place Holder <span class="text-danger">*</span> :</label>
                                            <input type="text" class="form-control" id="ser_name" name="name"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="name">Input ID <span class="text-danger">*</span> :</label>
                                            <input type="text" class="form-control" id="ser_name" name="name"
                                                placeholder="Enter Place Holder">
                                            <div class="invalid-feedback"> Name Required.</div>
                                        </div>
